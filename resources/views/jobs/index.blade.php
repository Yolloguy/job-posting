...
@section('content')
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header">{{ __('Create Job Posting') }}</div>
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('jobs.store') }}">
                            ...
                            <div class="form-group row">
                                <label for="recruiter" class="col-md-4 col-form-label text-md-right">{{ __('Recruiter') }}</label>

                                <div class="col-md-6">
                                    <input id="recruiter" type="text" class="form-control @error('recruiter') is-invalid @enderror" name="recruiter" value="{{ old('recruiter') }}" required autocomplete="recruiter">
